...
最初隔离验收的标准导出来自`workspace/disposal-cash-20260918/acceptance.duckdb`。随后已完成[正式主库备份发布](../../../docs/disposal-main-publication-20260918.md)：schema45、81字段，仅重算FN110；隔离样本验收与全库物化计数分别保留，不冒称全市场逐公司原文审核。
...
标准映射及两条零值补充现已[发布正式主库](../../../docs/disposal-main-publication-20260918.md)，实际主库证据已重新绑定政策并重开复验。两个标准缺期仍保留；闭合的是显式审核后的现金分量，不是公司资本倍率批准。
