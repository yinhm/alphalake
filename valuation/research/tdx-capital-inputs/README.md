...
状态：源数据扩展、2017年定向补采及三起点连续历史盘点完成；[旧期语义抽核](rd-semantics.md)确认七个正值及一个源零反例，非全样本审核；后续[研发净投入收入候选](../tdx-rd-growth/README.md)开发复验失败；后续[年度研发利润候选](../tdx-rd-profit/README.md)1,704组主误差与WAPE也退化，未采用新的增长政策。新增[两期研发范围桥接](rd-scope.md)确认FN304费用化、FN34期末存量与资本化投入流量的区别，不扩大600家完整输入覆盖。
...
已完成[两期年度再投资分量盘点](reinvestment-source.md)：债务五分量连续两年均非零仅33/37/33家，主要受可选债券源零影响；这是非零组合计数，不是可估值公司数。六家定向候选中首家[中国天楹](cnty-debt/README.md)两期债券零及8个非零源值已核验，另列约13.63亿元额外融资性款项；[其余五家](five-debt/README.md)两年40个源值也已核验，湖北宜化FN56零但仍有2,000万元到期债券的反例已锁定；[12期到期负债附注](maturities.md)现已全部加总闭合，保留本息混列、显式利息、未分类应付款和空白；[到期应付款性质](financing-payables.md)又完成三项归属、两项部分对应，保留青岛双星2022说明差额259.02万元及其余缺口；[缺口量级诊断](debt-materiality.md)显示中国天楹已识别额外融资款约为五字段小计的18%–20%，范围遗漏应优先于逐笔本金细分；[权益与现金核验](book-capital.md)另完成48个源位、24个比较列及金圆重述七项金额，长虹美菱2022两种现金扣减使资本算式由负转正；完整经营资本仍待推进。
...
本盘点未计算新的ROIC、FCFF、增长率或估值；后续收入候选的失败结果独立保存，没有把源盘点作为完整资本口径或预测有效性的证明。
