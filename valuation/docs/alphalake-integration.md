...
标准导出到共享引擎的CLI/API桥接已扩展到通用非金融政策、行业路由、参考WACC和批量/刷新入口。最新本地5,569家均有处理结论，2,461家条件估值；[全市场验收及运行命令](../../docs/a-share-automation-acceptance-20260910.md)为当前自动化入口。尚无自动选择全部专项模型的统一结果入口，也未部署后台周期任务。
