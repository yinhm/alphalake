# Ginzu Input Package — BABA (Alibaba Group Holding Limited)

**Generated:** 2026-04-29
**Source:** `TEST_DATA/TEST_BABA.xlsx` (CIQ-resolved)
**Ginzu workbook:** `knowledge_base/Ginzu_NVIDIA.xlsx`

## Instructions

1. Open `Ginzu_NVIDIA.xlsx`, immediately **Save As** `BABA_ginzu.xlsx`.
...
| `B4` | Company name | `Alibaba Group Holding Limited` |  |
| `B7` | Country of incorporation | `China` |  |
| `B8` | Industry (US) | `Retail (General)` |  |
| `B9` | Industry (Global) | `Retail (General)` |  |
| `B10` | Revenues (LTM) | `996,347.00` |  |
| `C10` | Revenues (prior FY) | `941,168.00` |  |
| `D10` | Years since last 10K | `0.000000` |  |
| `B11` | EBIT / Operating income (LTM) | `151,687.00` |  |
| `C11` | EBIT / Operating income (prior FY) | `138,718.00` |  |
| `B12` | Interest expense (LTM) | `9,596.00` |  |
| `C12` | Interest expense (prior FY) | `7,947.00` |  |
| `B13` | Book value of equity | `1,090,106.00` |  |
| `C13` | Book value of equity (prior) | `1,112,599.00` |  |
| `B14` | Book value of debt | `248,110.00` |  |
| `C14` | Book value of debt (prior) | `205,614.00` |  |
| `B15` | Capitalize R&D? | `Yes` |  |
| `B16` | Have operating leases? | `No` |  |
| `B17` | Cash + marketable securities | `145,487.00` |  |
| `C17` | Cash + marketable (prior) | `248,125.00` |  |
| `B18` | Cross holdings & non-op assets | `566,987.00` |  |
| `C18` | Cross holdings (prior) | `424,073.00` |  |
| `B19` | Minority interests | `80,248.00` |  |
| `C19` | Minority interests (prior) | `126,055.00` |  |
| `B20` | Shares outstanding | `2,319.16` |  |
| `B21` | Current stock price | `132.5200` |  |
| `B22` | Effective tax rate | `0.200000` |  |
| `B23` | Marginal tax rate | `0.250000` |  |
| `B25` | Revenue growth rate — next year | `0.100000` |  |
| `B26` | Operating margin — next year | `0.152243` |  |
| `B27` | CAGR revenue growth, years 2-5 | `0.080000` |  |
| `B28` | Target pre-tax operating margin | `0.068023` |  |
| `B29` | Year of margin convergence | `5` |  |
| `B30` | Sales/Capital ratio (years 1-5) | `3.5063` |  |
| `B31` | Sales/Capital ratio (years 6-10) | `3.5063` |  |
...
| `B7` | Current year R&D expense (LTM) | `57,151.00` |
...
- Ticker: `BABA`
- Ginzu base ERP + CRP (from Damodaran country dataset): `0.060559` (0.051429 base + 0.009129 country)
- Operating margin used (B26): LTM op-margin = `0.152243`
- Target operating margin used (B28): `0.068023` (industry median if available, else 0.9× current)
