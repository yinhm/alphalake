# Ginzu Input Package — MSFT (Microsoft Corporation)

**Generated:** 2026-04-29
**Source:** `TEST_DATA/TEST_MSFT.xlsx` (CIQ-resolved)
**Ginzu workbook:** `knowledge_base/Ginzu_NVIDIA.xlsx`

## Instructions

1. Open `Ginzu_NVIDIA.xlsx`, immediately **Save As** `MSFT_ginzu.xlsx`.
...
|------|-------|----------------|-------|
| `B3` | Date of valuation | `Jun 30, 2025` |  |
| `B4` | Company name | `Microsoft Corporation` |  |
| `B7` | Country of incorporation | `United States` |  |
| `B8` | Industry (US) | `Software (System & Application)` |  |
| `B9` | Industry (Global) | `Software (System & Application)` |  |
| `B10` | Revenues (LTM) | `281,724.00` |  |
| `C10` | Revenues (prior FY) | `245,122.00` |  |
| `D10` | Years since last 10K | `0.000000` |  |
| `B11` | EBIT / Operating income (LTM) | `128,528.00` |  |
| `C11` | EBIT / Operating income (prior FY) | `109,433.00` |  |
| `B12` | Interest expense (LTM) | `2,425.00` |  |
| `C12` | Interest expense (prior FY) | `2,983.00` |  |
| `B13` | Book value of equity | `343,479.00` |  |
| `C13` | Book value of equity (prior) | `268,477.00` |  |
| `B14` | Book value of debt | `112,184.00` |  |
| `C14` | Book value of debt (prior) | `97,852.00` |  |
| `B15` | Capitalize R&D? | `Yes` |  |
| `B16` | Have operating leases? | `No` |  |
| `B17` | Cash + marketable securities | `30,242.00` |  |
| `C17` | Cash + marketable (prior) | `18,315.00` |  |
| `B18` | Cross holdings & non-op assets | `15,405.00` |  |
| `C18` | Cross holdings (prior) | `14,600.00` |  |
| `B19` | Minority interests | `0` |  |
| `C19` | Minority interests (prior) | `0` |  |
| `B20` | Shares outstanding | `7,433.17` |  |
| `B21` | Current stock price | `424.8200` |  |
| `B22` | Effective tax rate | `0.200000` |  |
| `B23` | Marginal tax rate | `0.258861` |  |
| `B25` | Revenue growth rate — next year | `0.100000` |  |
| `B26` | Operating margin — next year | `0.456220` |  |
| `B27` | CAGR revenue growth, years 2-5 | `0.080000` |  |
| `B28` | Target pre-tax operating margin | `0.329825` |  |
| `B29` | Year of margin convergence | `5` |  |
| `B30` | Sales/Capital ratio (years 1-5) | `1.5382` |  |
| `B31` | Sales/Capital ratio (years 6-10) | `1.5382` |  |
...
| `B7` | Current year R&D expense (LTM) | `32,488.00` |
...
- Operating margin used (B26): LTM op-margin = `0.456220`
- Target operating margin used (B28): `0.329825` (industry median if available, else 0.9× current)
