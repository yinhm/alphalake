...
if __name__ == '__main__':
    ...
    names = ('data_sources/alphalake_calibration.py', 'tools/backtest_tdx_history.py', 'tools/tdx_research_source.py', 'tools/backtest_tdx_multiyear_growth.py', 'tools/backtest_tdx_normalized_margin.py', 'tools/backtest_tdx_revenue_cagr.py')
