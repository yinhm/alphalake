...
def engine_revision():
    ...
    paths = sorted((root/'engine').glob('*.py'))+[root/'data_sources/alphalake.py',root/'data_sources/alphalake_wacc.py',root/'data_sources/alphalake_capital.py',root/'data_sources/alphalake_market.py',Path(__file__).resolve()]
