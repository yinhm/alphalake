...
[零增长联合开发复验](../valuation/research/tdx-zero-calibration/README.md)现已失败：600家、三起点的组合主误差改善约2.07%，不足5%，WAPE退化；不能把两项各有历史证据的规则直接叠加。该研究扩大训练集合并排除目标公司，另有短期缺项回退，与本页原政策不完全相同；没有更新生产系数、采用范围或叠加限制。
