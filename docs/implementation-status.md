...
| 派生研究/估值/因子 | 部分实现 | 已有年度/TTM 财务窗口；完整估值模型、因子及回测仍在计划中。 |
...
2026-09-06 资本开支补证：已归档安克 2022 年报，离线核对五段原文、七个金额，确认 11.4416 亿元现金资本开支与既有历史表一致，并记录深圳办公/研发中心购房背景。合同总价与预付款变动分别保留；购房当期现金及维持性资本开支仍未精确拆分。见[研究记录](anker-valuation-20260906.md)及历史样本 `capex-review.csv`；下一步跟踪项目交付、转固和折旧，不直接生成正常化投入数。
