...
本轮已新增 20 个映射，完成现金/权益及部分借款、营运资本、资本开支和折旧摊销明细的真实对账；尚不等于全部十二组输入完整。随后又补入 9 个税项、利息、应付债券、非流动租赁负债与使用权资产折旧字段。年度/TTM 查询及两家公司连续六季度验收现已完成：2025 年末与 2026 半年末各 76/76 个已映射字段窗口完整，2026 一季末为 68/76；这只是样本窗口完整率。下一阶段选一家普通非金融公司，结合附注补齐 EBIT 非经营项目调整、到期债务拆分及非现金营运资本，交付可复算的估值财务输入表，并逐步扩大公司及多年历史覆盖。经营现金流不等于 FCFF，投资现金流净额不等于资本开支。折现率、增长、目标利润率和再投资效率等市场输入及预测假设需单独提供，不冒充财务报表事实。
