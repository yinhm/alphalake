...
随后已选安克创新完成三张可复算的财务分析表：融资/投资调整 EBIT、含到期部分的账面有息债务、宽口径及已识别项目调整后的非现金营运资本。原文 314 个金额及 69 个 TDX 源值已核对；历史混合项分类不全，完全分类后的营运资本年度/TTM 变动仍为空，见[安克研究记录](anker-valuation-20260906.md)。下一阶段补折旧摊销、现金资本开支与营运资本现金流衔接，随后扩大公司及多年历史覆盖。
