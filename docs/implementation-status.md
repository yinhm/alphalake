...
随后已选安克创新完成九张可复算的财务分析表：融资/投资调整 EBIT、含到期部分的账面有息债务、非现金营运资本、净利润至经营现金流调节、再投资口径差额、租赁投入、税项、应收/应付差额分解及应收原值/净额与准备变动。原文 564 个金额及 84 个 TDX 源值已核对，Python 离线校验已接入 CI 配置；历史混合项分类不全，完全分类后的营运资本年度/TTM 变动仍为空，见[安克研究记录](anker-valuation-20260906.md)。折旧摊销和现金资本开支已补齐，存货的原值/净值差额已核对，剩余口径差额已分解到应收/应付两侧，尚未完成经济原因归因。租赁资产/负债变动及税费调节已闭合。应收侧已补齐准备变动并定位远期资产余额的影响；剔除远期资产或改用应收原值只是敏感性，尚无现金流分类归因。下一阶段优先补套期结算、非现金变动及经营应收/应付分类证据，再确定完整再投资与经营税项政策，再扩大公司及多年历史覆盖。
