...
随后已选安克创新完成五张可复算的财务分析表：融资/投资调整 EBIT、含到期部分的账面有息债务、非现金营运资本、净利润至经营现金流调节及再投资口径差额。原文 409 个金额及 84 个 TDX 源值已核对，Python 离线校验已接入 CI 配置；历史混合项分类不全，完全分类后的营运资本年度/TTM 变动仍为空，见[安克研究记录](anker-valuation-20260906.md)。折旧摊销和现金资本开支已补齐，存货的原值/净值差额已核对，剩余应收/应付等口径差额仍未归因。下一阶段先处理这些差额及租赁再投资、税项政策，再扩大公司及多年历史覆盖。
