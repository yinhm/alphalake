...
随后已选安克创新完成八张可复算的财务分析表：融资/投资调整 EBIT、含到期部分的账面有息债务、非现金营运资本、净利润至经营现金流调节、再投资口径差额、租赁投入、税项及应收/应付差额分解。原文 496 个金额及 84 个 TDX 源值已核对，Python 离线校验已接入 CI 配置；历史混合项分类不全，完全分类后的营运资本年度/TTM 变动仍为空，见[安克研究记录](anker-valuation-20260906.md)。折旧摊销和现金资本开支已补齐，存货的原值/净值差额已核对，剩余口径差额已分解到应收/应付两侧，尚未完成经济原因归因。租赁资产/负债变动及税费调节已闭合。下一阶段优先核实应收侧残差，再确定完整再投资与经营税项政策，再扩大公司及多年历史覆盖。
