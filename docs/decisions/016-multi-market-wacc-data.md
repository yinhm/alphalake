...
状态：部分结构已实现。迁移 027 建立发布版本、归档关联及四类参考观测；后续已接入 CN/HK/US 国家风险的限定发布链（见[同步说明](../country-risk-sync.md)），全球行业 Beta 与人民币国债收益率也已接入（见[说明](../beta-yield-sync.md)），汇率与 WACC 选择器待实现。
