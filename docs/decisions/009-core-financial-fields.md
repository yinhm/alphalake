...
新增字段均为人民币元，沿用 float32 到 DECIMAL(38,10) 的确定性表示，不恢复源编码丢失的分位。这些映射原从2025-01-01起有效；迁移038仅将FN114扩展到2024-06-30，依据[安克2024三期原文及TDX源位核验](../../internal/ingest/testdata/anker-cash-history-2024/README.md)。其他字段的早期审核边界不变；单公司样本不代表全市场逐公司原文核验。既有映射的有效期不变，报表范围仍为 `provider_default`，本次合并报表样本不能证明所有公司、所有报告期口径都一致。
