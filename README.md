...
- 已审核的 38 个 TDX 字段映射，含单季度利润/现金流、股本，以及现金、借款、债券、租赁、税项、利息、权益和再投资明细；新增字段区分期末存量与年初累计，见[核心财务字段](docs/decisions/009-core-financial-fields.md)；
...
第二个样本[贵州茅台验证性估值](docs/moutai-validation-valuation-20260906.md)已完成财务公司口径、储酒投入和股权桥接的显式情景建模；CI 另离线核对八份 PDF、437 个数值及九张表。纯酒业历史现金流缺口保留，结果不是当前目标价。
